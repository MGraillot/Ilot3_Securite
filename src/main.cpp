...
const int sensorPin1 = 10; // Capteur 1 (analogique)
const int sensorPin2 = 11; // Capteur 2 (analogique)
const int sensorPin3 = 12; // Capteur 3 (analogique)
const int sensorPin4 = 13; // Capteur 4 (analogique)
